...
{
    //reference to an Image which we can set to use 1 of 3 different sprites (set depending on state flags)
    ...
    //add a few convenience properties which allow me to get and set whether or not the flags are set
